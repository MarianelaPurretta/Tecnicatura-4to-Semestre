from LOGGIN.capa_datos_persona.cursor_del_pool import CursorDelPool
...
class UsuarioDAO:
    ...
    _SELECT = 'SELECT * FROM usuario ORDEY BY id_usuario'
    _INSERTAR = 'INSERT INTO usuario(username, password) VALUE (%s, %s)'
    _ACTUALIZAR = 'UPDATE usuario SER username=%s, password=%s WHERE id_usuario=%s'
